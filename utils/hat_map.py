...
def get_params():
    params = {
        'weight': '/home/jxndp/qaqwzm/yolov7-couping/runs/train/Yolov7-Tiny1/weights/best.pt',
        'cfg': 'cfg/training/yolov7-tc.yaml',
        'device': 'cuda:1',
...
if __name__ == '__main__':
    ...
    model('/home/jxndp/qaqwzm/yolov7-couping/inference/guoshiyin/IMG20230923094102.jpg', 'result')