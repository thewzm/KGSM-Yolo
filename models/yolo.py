...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in [nn.Conv2d, Conv, RobustConv, RobustConv2, DWConv, GhostConv, RepConv, RepConv_OREPA, DownC, 
                 ...
                 Yolov7x_E_ELAN,GSConv,GSELAN,GSELANC]:
            c1, c2 = ch[f], args[0]
...
if __name__ == '__main__':
    ...
    #parser.add_argument('--cfg', type=str, default='./cfg/training/yolov7-tc-SimAM.yaml', help='model.yaml')
    #parser.add_argument('--cfg', type=str, default='../cfg/baseline/yolov4-csp.yaml', help='model.yaml')
    parser.add_argument('--cfg', type=str, default='cfg/training/yolov7-tc-ours.yaml', help='model.yaml')
